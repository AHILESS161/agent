...
> **Статус документа:** исходная целевая модель. Реальная схема SQLAlchemy и
> миграции Alembic являются источником правды; часть описанных ниже полей и
> связей отсутствует. Текущий маршрут описан в
