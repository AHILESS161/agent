...
Конвейер генерации документов создаёт полный пакет юридических документов для подачи в ФИПС на основе утверждённых данных заявки. Все документы генерируются в формате DOCX (Microsoft Word) с соблюдением требований Роспатента.
