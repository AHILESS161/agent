...
> **Актуализация 15.08.2026:** документ сочетает исходную спецификацию и
> реализованные контракты. Клиентский черновик, скачивание рабочего DOCX и
> расчёт пошлин описаны в конце файла. Фактическая OpenAPI-схема доступна на
> `/docs`; общий срез — [`current-state.md`](current-state.md).
