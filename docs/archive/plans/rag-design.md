...
> Архивная целевая спецификация, написанная до текущей реализации. Рабочий
> BM25-контур и его ограничения описаны в `docs/rag-and-legal-safety.md`.

> **Статус на 15.08.2026:** целевая спецификация. Сейчас работает BM25 по
> локальному корпусу; pgvector/Qdrant, полный ingestion и часть метрик ниже не
> реализованы. Фактические ограничения — [`current-state.md`](../../current-state.md).
