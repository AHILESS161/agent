...
| Рабочий черновик заявления | ✅ предпросмотр и скачивание DOCX |
...
1. Войти под `client@demo.ru` и создать заявку либо открыть существующую.
...
7. На этапе **«Результат»** открыть и скачать DOCX-черновик, проверить ручные
   поля и расчёт пошлин.
