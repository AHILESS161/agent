...
interface ApplicationDto {
  ...
  client_progress_state?: string;
  client_progress_step?: 1 | 2 | 3 | 4;
  priority?: string;
...
function toApplication(dto: ApplicationDto): Application {
  return {
    ...
    status: dto.status,
    clientProgressStep: dto.client_progress_step,
    clientProgressState: dto.client_progress_state,
    ...
    markImageFileId: dto.mark_image_file_id ?? "",
    ...
    representativeId: dto.representative_id ?? null,
