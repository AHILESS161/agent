...
# Пункт может быть дробным: «Пункт 1.1» статьи 1483 — исключения
# из пункта 1. Без дробной части якорь ссылался бы на пункт 1,
# то есть на прямо противоположную норму.
